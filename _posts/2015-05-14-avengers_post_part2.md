...
[RxAndroid](https://github.com/ReactiveX/RxAndroid) are a few specific android utilities for [RxJava](https://github.com/ReactiveX/RxJava) by [Jake Wharton](http://jakewharton.com/), which includes some [Schedulers](http://reactivex.io/documentation/scheduler.html) to manage the threads of the Android platform. 
...
- [Use Lambdas on Java 7 and older](https://www.youtube.com/watch?v=DUdhfPh9V_s)
